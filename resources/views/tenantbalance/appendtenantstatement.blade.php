...
<div class="row">
    ...
    <div class="col-md-4">
        {{-- <form action="{{ route('tenant.makestatement')}}" method="POST">
            @csrf
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default" style="background-color: rgb(174, 177, 174);margin-top: 1%">
                ...
                <div class="panel-body" style="max-height: 800px;background-color: white;overflow: auto">
                    ...
                    <p><h4  class="text-center"><b>{{($address)?$address:'' }}</b></h4></p>
                    <p><h4  class="text-center"><b>Cell:{{($phonenumber)?$phonenumber:'' }}</b></h4></p>
                    <p><h4  class="text-center"><b>Email:{{($email)?$email:'' }}</b></h4></p>
            ...
            <div class="row" style="margin-top: -10px">
                <div class="container">
                    <div class="col-md-4"></div>
                    <div class="col-md-2"><p>Tenant Code: {{ $tcode}}</p></div>
                    <div class="col-md-6"><p>Tenant Name: {{ $tenantname }}</p></div>
                </div>
            </div>
            <div class="row">
                <div class="container">
                    <div class="col-md-4"></div>
                    <div class="col-md-3"><p>Property: {{ $propertyid }}</p></div>
                    <div class="col-md-2"><p>Unit: {{ $unitid }}</p></div>
                </div>
            </div>
            <div class="row" >
        <div class="container">
